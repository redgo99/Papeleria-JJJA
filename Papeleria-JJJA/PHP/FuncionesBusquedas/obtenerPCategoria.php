...
if (isset($_POST["categoria"])) {
    ...
    $categoria = "No listada";
}

$query = "CALL buscarProductosPorCategoria('$categoria' ,@error)";
...
if ($result && $result->num_rows > 0) {
    ...
    echo "<p  class='alertaBusqueda' >No se encontraron productos en la categoría: $categoria.</p>";
}
